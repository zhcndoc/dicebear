...
export const clothing: ComponentGroup = {
  ...
  graphicShirt: (
    ...
    `<path d="M132.5 54C151 54 166 44.37 166 32.5c0-1.1-.13-2.18-.38-3.23A72 72 0 0 1 232 101.05V110H32v-8.95A72 72 0 0 1 99.4 29.2a14.1 14.1 0 0 0-.4 3.3C99 44.37 114 54 132.5 54Z" fill="${escape.xml(`${colors.clothes}`)}"/><g transform="translate(77 58)">${components.clothingGraphic?.value(components, colors) ?? ''}</g>`,
  ...
  overall: (components: ComponentPickCollection, colors: ColorPickCollection) =>
    `<path d="M196 38.63V110H68V38.63a71.52 71.52 0 0 1 26-8.94v44.3h76V29.69a71.52 71.52 0 0 1 26 8.94Z" fill="${escape.xml(`${colors.clothes}`)}"/><path d="M86 83a5 5 0 1 1-10 0 5 5 0 0 1 10 0ZM188 83a5 5 0 1 1-10 0 5 5 0 0 1 10 0Z" fill="#F4F4F4"/>`,
  shirtCrewNeck: (
    components: ComponentPickCollection,
    colors: ColorPickCollection,
  ) =>
  ...
  shirtScoopNeck: (
    ...
    `<path d="M132.5 65.83c27.34 0 49.5-13.2 49.5-29.48 0-1.37-.16-2.7-.46-4.02A72.03 72.03 0 0 1 232 101.05V110H32v-8.95A72.03 72.03 0 0 1 83.53 32a18 18 0 0 0-.53 4.35c0 16.28 22.16 29.48 49.5 29.48Z" fill="${escape.xml(`${colors.clothes}`)}"/>`,
  shirtVNeck: (
    components: ComponentPickCollection,
    colors: ColorPickCollection,
  ) =>
    `<path d="M92.68 29.94A72.02 72.02 0 0 0 32 101.05V110h200v-8.95a72.02 72.02 0 0 0-60.68-71.11 23.87 23.87 0 0 1-7.56 13.6l-29.08 26.23a4 4 0 0 1-5.36 0l-29.08-26.23a23.87 23.87 0 0 1-7.56-13.6Z" fill="${escape.xml(`${colors.clothes}`)}"/>`,
};
