...
export const frontHair: ComponentGroup = {
  variant12: (
    ...
    `<path d="M374 130c6.5 15.9 11.5 34.5 11.5 70-11 0-73.7 6-114.5-10s-46.9-28.5-60-48c-13 27-37 38-73.5 48s-83.3 7.5-99.5 10c0-23.1 2-46 10.9-67.4A176 176 0 0 1 211 24a175 175 0 0 1 124 51.5c16.4 16.4 30.2 33.1 39 54.5Z" fill="${escape.xml(`${colors.hair}`)}"/>`,
  variant11: (
    components: ComponentPickCollection,
    colors: ColorPickCollection,
  ) =>
    `<path d="M374 133c6.5 15.9 11.5 34.5 11.5 70-11 0-38.5 11-92.5-18-54.8-29.5-68.9-59.5-82-79-13 27-37 51.3-72.5 73.5C103 201.7 54.2 200.5 38 203c0-23.1 2-46 10.9-67.4A176 176 0 0 1 211 27a175 175 0 0 1 124 51.5c16.4 16.4 30.2 33.1 39 54.5Z" fill="${escape.xml(`${colors.hair}`)}"/>`,
  variant10: (
    components: ComponentPickCollection,
    colors: ColorPickCollection,
  ) =>
  ...
  variant06: (
    ...
    `<path d="M375 133c6.5 15.9 11.5 34.5 11.5 70-11 0-47.9-4.6-107.3-23-59.5-18.4-101.6-50-114.7-69.5.3 6 0 34-19.7 55A124.2 124.2 0 0 1 39 203c0-23.1 2-46 10.9-67.4A176 176 0 0 1 212 27a175 175 0 0 1 124 51.5c16.4 16.4 30.2 33.1 39 54.5Z" fill="${escape.xml(`${colors.hair}`)}"/>`,
  variant05: (
    components: ComponentPickCollection,
    colors: ColorPickCollection,
  ) =>
    `<path d="M384.9 132.5a185.5 185.5 0 0 1 14.1 71H151.5l-24-47-24 47H28a185.5 185.5 0 0 1 356.9-71Z" fill="${escape.xml(`${colors.hair}`)}"/>`,
  variant04: (
    components: ComponentPickCollection,
    colors: ColorPickCollection,
  ) =>
  ...
  variant01: (
    ...
    `<path d="M399 203.5a185.5 185.5 0 0 0-371 0h371Z" fill="${escape.xml(`${colors.hair}`)}"/>`,
};
