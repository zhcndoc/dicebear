...
export const facialHair: ComponentGroup = {
  ...
  shadow: (components: ComponentPickCollection, colors: ColorPickCollection) =>
    `<path opacity=".2" d="M32 3v4A14 14 0 1 1 4 7V2.7c2.05 2.94 4.53 6.97 8 8.3 2-1 4-1.5 6-1.5s4 .5 6 1.5c3.47-1.33 5.95-5.36 8-8.3V3Z" fill="${escape.xml(`${colors.hair}`)}"/>`,
  soulPatch: (
    components: ComponentPickCollection,
    colors: ColorPickCollection,
  ) =>
    `<path d="M16 17.5h4l-.68 2.05a1.39 1.39 0 0 1-2.63 0l-.7-2.05Z" fill="${escape.xml(`${colors.hair}`)}"/>`,
};
