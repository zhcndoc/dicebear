...
export const body: ComponentGroup = {
  squared: (components: ComponentPickCollection, colors: ColorPickCollection) =>
    `<path d="M16 5v3a5 5 0 0 0 10 0V5l6.65 2.05a9 9 0 0 1 6.35 8.6V20H3v-4.35a9 9 0 0 1 6.35-8.6L16 5Z" fill="${escape.xml(`${colors.clothing}`)}"/>`,
  rounded: (components: ComponentPickCollection, colors: ColorPickCollection) =>
    `<path d="M16 7v.47a5 5 0 1 0 10 0V7c7.06 1.52 12.93 6.74 16 13H0C3.07 13.74 8.94 8.52 16 7Z" fill="${escape.xml(`${colors.clothing}`)}"/>`,
