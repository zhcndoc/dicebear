  ...
  <UiSection ref="sectionRef" :class="{ visible: isVisible }" divider center>
    ...
    <UiContainer class="app-cta-container">
      ...
      <UiDescription class="app-cta-description">
        Join thousands of developers using DiceBear. Create unique profile
        pictures — forever free.
      </UiDescription>
      ...
      <div class="app-cta-proof-links">
        ...
        <a v-if="requestsLabel" href="/stats/" class="app-cta-proof-link">
...
.app-cta {
  &-gradient {
    background:
      ...
      radial-gradient(
        ellipse 40% 40% at 30% 30%,
        color-mix(in srgb, var(--vp-c-purple-1) 5%, transparent),
        transparent
      ),
      radial-gradient(
        ellipse 40% 40% at 70% 70%,
        color-mix(in srgb, var(--vp-c-green-1) 4%, transparent),
        transparent
      );
  }
