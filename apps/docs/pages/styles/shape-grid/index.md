...
Shape Grid is an abstract vector avatar style that arranges four simple
shapes — squares, circles, triangles, and hexagons — in a 2×2 grid on a
tinted background. Generate playful, distinctive SVG profile icons that work
